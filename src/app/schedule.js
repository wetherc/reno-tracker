// The schedule section: a table of every item in the open project, an
// Add button in the panel header, and a checkbox per row that marks the
// work done. The title opens the editor.
